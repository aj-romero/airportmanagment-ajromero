...
public class DepartureGatesUI {
  ...
  public static void showDepartureGatesState() {
    ...
    for (int i = 0; i < gates.size(); i++) {
      ...
      else System.out.printf("%-5d | %-20s | %-10s%n", i, gates.get(i).getGateName(), "Disponible");
    }
  }
  ...
  public static void showMenu() {
    System.out.printf(
        "%n%n | %-10s | %-10s | %-20s | %-10s%n",
        "[1] Asignar", "[2] Liberar", "[3] Regresar al menu principal", "[4] Salir");
  ...
  public static void liberarAction() {
    ...
    while (!GateUI.checkValidId(id)) {
      ...
      System.out.printf(
          "%n%n | %-15s", "De la lista anterior ingrese el ID de la puerta a liberar:");
